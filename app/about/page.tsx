...
const ECOSYSTEM = [
  ...
  { name: 'OGForge', desc: 'AI social card generator', href: 'https://ogforge.vercel.app', active: true },
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="mb-16">
          <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors mb-8 inline-block">&larr; Back to OGForge</Link>
          <h1 className="text-4xl font-bold text-white mb-4">About OGForge</h1>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.2 }} className="mb-16">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
            <p className="text-zinc-300 leading-relaxed mb-4">
              AI Business Factory builds developer tools powered by AI. We believe every link shared on social media deserves a stunning preview card — not a broken image or blank thumbnail.
            </p>
            <p className="text-zinc-300 leading-relaxed">
              OGForge generates beautiful Open Graph images for Twitter, LinkedIn, Facebook, and Discord in seconds. Choose from 6 color presets and 5 styles, then download high-res PNGs ready to upload.
            </p>
          </div>
        </motion.section>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.4 }} className="mb-16">
          ...
          <div className="flex flex-wrap gap-2">
            {['Next.js', 'TypeScript', 'React', 'Tailwind CSS', 'Framer Motion', '@vercel/og', 'Vercel', 'x402 (USDC on Base)'].map((tech) => (
