  ...
  return (
    <article className="prose-invert mx-auto max-w-3xl space-y-12 px-4 py-16 text-zinc-300 sm:px-6 lg:px-0">
      ...
      <Section id="payments" title="4. Payments and Refunds">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong className="text-white">Pricing.</strong> All prices are displayed in the applicable currency at checkout. We reserve the right to change pricing at any time; existing subscriptions will be honoured at the price in effect at the time of purchase until the current billing cycle ends.
          </li>
          <li>
            <strong className="text-white">Payment processing.</strong> Payments are handled by Stripe (credit/debit cards) and Coinbase Commerce (cryptocurrency). Your use of these payment processors is subject to their respective terms of service.
          </li>
          <li>
            <strong className="text-white">Digital products &mdash; no refunds.</strong>{" "}
            Due to the nature of digital products, all sales are final. No refunds will be issued once a digital product has been delivered or a subscription activated, except where required by applicable law.
          </li>
          <li>
            <strong className="text-white">Subscriptions.</strong> Subscriptions renew automatically. You may cancel at any time through your account settings; cancellation takes effect at the end of the current billing period.
          </li>
        </ul>
      </Section>
      ...
      <Section id="termination" title="8. Termination">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>You remain liable for any outstanding payments due prior to termination.</li>
          <li>We may delete your account data after a reasonable retention period (typically 30 days), unless we are required by law to retain it.</li>
        </ul>
        <p>
          You may terminate your account at any time by contacting us at{" "}
          <a href={`mailto:${contactEmail}`} className="text-white underline underline-offset-4 hover:text-zinc-200">{contactEmail}</a>{" "}
          or through your account settings.
        </p>
      </Section>

      <Section id="governing-law" title="9. Governing Law and Jurisdiction">
        <p>These Terms shall be governed by and construed in accordance with {governingLaw}, without regard to conflict-of-law principles.</p>
        <p>Any disputes arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of {jurisdiction}.</p>
      </Section>

      <Section id="severability" title="10. Severability">
        <p>If any provision of these Terms is held to be invalid or unenforceable, the remaining provisions shall continue in full force and effect. The invalid or unenforceable provision will be modified to the minimum extent necessary to make it valid and enforceable.</p>
      </Section>

      <Section id="entire-agreement" title="11. Entire Agreement">
        <p>
          These Terms, together with our{" "}
          <a href="/privacy" className="text-white underline underline-offset-4 hover:text-zinc-200">Privacy Policy</a>
          , constitute the entire agreement between you and {companyName} regarding the Service and supersede all prior agreements and understandings.
        </p>
      </Section>
      ...
      <Section id="contact" title="12. Contact Us">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            <a href={websiteUrl} className="text-white underline underline-offset-4 hover:text-zinc-200">{websiteUrl}</a>
          </li>
        </ul>
      </Section>
    </article>
